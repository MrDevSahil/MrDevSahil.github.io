...
function Form() {
  ...
  <div className="mx-3 xs:mx-5 sm:mx-16 md:mx-24 lg:mx-32 xl:mx-40 pb-7 xs:pb-9 sm:pb-14 md:pb-20 justify-center">
    <div className="lg:w-4/5 xl:w-3/4 mx-auto">
      <h2 className="mt-2 xs:mt-3 md:mt-5 text-xl md:text-3xl xl:text-4xl font-bold">Let's work together<span className="text-yellow-500">.</span></h2>
      <p className="mt-2 xs:mt-3 md:mt-5 text-base md:text-lg xl:text-xl font-medium leading-5 xs:leading-6 md:leading-7 text-slate-500">or reach us via :
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-3 xs:mt-5 md:mt-7 flex gap-5 w-full">
            ...
            <div className="relative h-10 xs:h-11 sm:h-12 md:h-14 lg:h-16 w-1/2 rounded-full">
              <button type="submit" className="px-3 xs:px-5 sm:px-7 text-lg md:text-xl xl:text-2xl font-semibold leading-4 w-full h-full text-slate-50 hover:text-slate-100 font-semibold bg-yellow-400 hover:bg-slate-500 rounded-full transition duration-200">Send message</button>
            </div>
          </div>
        </form>
      </div>
