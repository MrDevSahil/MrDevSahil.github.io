    ...
    <footer className="px-96 py-20 footer text-white bg-slate-800">
      <div>
          ...
          <div>
            ...
            <form action="" className="w-fit rounded-md">
              ...
              <button
                ...
                className="px-6 py-4 bg-[#029D9D] rounded-r-md"
              >
                Subscribe
              </button>
              <p
                className={`mt-3 text-lg text-green-400 ${subscribed ? "opacity-100" : "opacity-0"}`}
              >
        ...
        <div className="flex items-center justify-between">
          <Link to={"/projects/travo"} className="text-4xl font-extrabold">
            Travo
          </Link>
          <p>
            &copy; 2023 <Link to={"https://kodevana.com"}>KodeVana</Link>. All
            Rights Reserved
          </p>
