  ...
  return (
    <div style={{ height: "100vh", overflowY: "auto", background: C.bg }}>
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        {/* ── Header ── */}
        <header style={{ borderBottom: `1px solid ${C.border}`, paddingBottom: 20, marginBottom: 36 }}>
          <pre style={{
          ...
          <p style={{ fontFamily: "var(--font-mono)", fontSize: 12, color: C.muted }}>
            ...
            <span style={{ color: C.amber }}>guwahati, IN</span>
            {" "}— building things that are fast
          </p>
        </header>

        {/* ── Tab nav ── */}
        <nav style={{ display: "flex", width: "fit-content", border: `1px solid ${C.border}`, marginBottom: 36 }}>
          {TABS.map((t, i) => {
            const active = tab === t;
        ...
        <footer style={{
          ...
          <span>built with vite + react<Cursor /></span>
        </footer>
